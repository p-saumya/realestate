...
//     const [discountApplied, setDiscountApplied] = useState(0); // For showing the discount amount
...
//             const discountAmount = totalPrice*0.01; // Amount of discount
...
//         <>
//             <Helmet>
//                 <title>AD-WISE - {`${listing.title}`} - Buy</title>
//                 <meta name="description" content="Listing detail" />
//             </Helmet>
//             {isAuthenticated ? (
//                 <div className="container my-3">
//                     <div className="row">
//                         <div className="col-md-8 col-12 add-border rounded">
...
//                                     <p>Tax: </p>
//                                 </div>
//                                 <div className="col-md-4 margin-left-0">
//                                     <p>₹ {listing.price}</p>
...
//                                 <h2 className="text-center">Make Payment Now</h2>
//                             </div>
...
//                                         >
//                                             Enter a valid coupon code if available.
//                                         </small>
//                                     </div>
//                                     <button
//                                         type="button"
                ...
                <div className="container my-3">
                    <div className="row">
                        ...
                        <div className="col-md-4 col-12 border p-0 shadow-lg bg-white rounded">
                            ...
                            <div className="make-payment-div rounded">
                                <h2 className="text-center">Make Payment Now</h2>
                            </div>
                            <div className="form-div mt-3 mx-2">
                                <form>
                                    <div className="form-group">
                                        <input
                                            ...
                                            placeholder="Enter Coupon Code"
                                        />
                                        <small id="couponHelp" className="form-text text-muted">
                                            Enter a valid coupon code if available.
                                        </small>
                                    </div>
                                    <button
