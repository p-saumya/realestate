            ...
            {isAuthenticated ? (
                <>
                    ...
                    <div className="container mt-3 ">
                        ...
                        <div className="row my-3 add-border">
                            <div className="col-md-9 col-12">
                                <figure>
                                    <img
                                        ...
                                        alt="image"
                                        width="100%"
                                        height="auto" style={{ paddingTop: '30px' }}
                                    />
                                </figure>
                            ...
                            <div className="col-md-3 col-12" style={{ border: '1px solid darkblue' }}>
                        ...
                        <div className="contact-section">
                            <div className="link-bar my-4">
                                <h3 style={{fontWeight: 'bold' }}>Contact Seller</h3>
                            </div>
